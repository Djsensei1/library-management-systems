...
// const phoneRegExp =
//   /^(\+250\s7\d{2}\s\d{3}\s\d{3}|\+2507\d{8}|07\d{2}\s\d{3}\s\d{3}|07\d{8})$/; // +250 7xx xxx xxx, +2507xxxxxxxx, 07xx xxx xxx, and 07xxxxxxxx
const validationSchema = Yup.object({
  ...
  phone: Yup.string()
    .matches(phoneRegExp, "Please enter an valid phone number")
    .required("Please enter your phone number"),
  dob: Yup.date()
    .required("Please select you date of birth.")
